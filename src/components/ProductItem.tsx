...
const ProductItem = ({product}: props) => {
    const {addItemToCart, getProductQuantity, removeItemFromCart, deleteFromCart} = useContext(CartContext);
    ...
    return (
        <Card className={"mt-5 card-bg"}>
            <CardBody>
                ...
                <Card.Text className={"text-light justify-content-end"} dir="rtl" >{product.price} تومان</Card.Text>
                {productQuantity > 0 ? (
                    <>
                     <Form as={Row}>
